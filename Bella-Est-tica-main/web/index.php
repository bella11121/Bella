...
<div class="row">
    ...
    <div class="content">
        ...
        <p>Fundada por quatro amigos dedicados, a Clínica Bela Estética começou em um pequeno 
            espaço, onde buscavam oferecer algo único. Inspirados em viagens ao redor do mundo, desenvolveram o
...
<h1 class="sobre"> Mais  <span>Pedidos</span> </h1>
...
<div class="box-container">
    ...
    <div class="box">
        ...
        <div class="content">
            ...
            <div class="price"> $9.99 <span>$20.99</span></div>
        </div>
    </div>
    ...
    <div class="box">
        ...
        <div class="content">
            ...
            <div class="price"> $29.99 <span>$20.99</span></div>
        </div>
    </div>
    ...
    <div class="box">
        ...
        <div class="image">
            <img src="../img/depilação111.jpg" alt="">
        </div>
        <div class="content">
